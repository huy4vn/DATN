...
namespace RTree
{
    ...
    {
        public const int locking_timeout = 10000;
        [NonSerialized]
        internal ReaderWriterLock locker = new ReaderWriterLock();
        private const string version = "1.0b2p2";

        // parameters of the tree
        public const int DEFAULT_MAX_NODE_ENTRIES = 10;
        ...
        //public TIntObjectHashMap nodeMap = new TIntObjectHashMap();
        public Dictionary<int, Node<T>> nodeMap = new Dictionary<int, Node<T>>();

        // public consistency checking - set to true if debugging tree corruption
        public bool INTERNAL_CONSISTENCY_CHECKING = false;

        // used to mark the status of entries during a Node&lt;T&gt; split
        public const int ENTRY_STATUS_ASSIGNED = 0;
        public const int ENTRY_STATUS_UNASSIGNED = 1;
        public byte[] entryStatus = null;
        public byte[] initialEntryStatus = null;
        ...
        //public TIntStack parents = new TIntStack();
        public Stack<int> parents = new Stack<int>();
        //public TIntStack parentsEntry = new TIntStack();
        public Stack<int> parentsEntry = new Stack<int>();
        ...
        //public int highestUsedNodeId = rootNodeId; 
        public int highestUsedNodeId = 0;

        // Deleted Node&lt;T&gt; objects are retained in the nodeMap, 
        // so that they can be reused. Store the IDs of nodes
        // which can be reused.
        //public TIntStack deletedNodeIds = new TIntStack();
        public Stack<int> deletedNodeIds = new Stack<int>();

        // List of nearest rectangles. Use a member variable to
        // avoid recreating the object each time nearest() is called.
        //public TIntArrayList nearestIds = new TIntArrayList();
        ...
        public volatile int idcounter = int.MinValue;
        ...
        public void add(Rectangle r, int id, int level)
        {
        ...
        public void nearest(Point p, Action<int> v, float furthestDistance)
        {
        ...
        public void intersects(Rectangle r, Action<int> v)
        {
            Node<T> rootNode = getNode(rootNodeId);
        ...
        public void contains(Rectangle r, Action<int> v)
        {
        ...
        public Node<T> splitNode(Node<T> n, Rectangle newRect, int newId)
        {
        ...
        public void pickSeeds(Node<T> n, Rectangle newRect, int newId, Node<T> newNode)
        {
        ...
        /// <param name="newNode"></param>
        /// <returns></returns>
        public int pickNext(Node<T> n, Node<T> newNode)
        {
        ...
        /// <returns></returns>
        public float nearest(Point p, Node<T> n, List<int> nearestIds, float nearestDistance)
        {
            for (int i = 0; i < n.entryCount; i++)
            {
        ...
        /// <param name="v"></param>
        /// <param name="n"></param>
        public void intersects(Rectangle r, Action<int> v, Node<T> n)
        {
            for (int i = 0; i < n.entryCount; i++)
            {
                if (r.intersects(n.entries[i]))
        ...
        public Rectangle oldRectangle = new Rectangle(0, 0, 0, 0, 0, 0);
        ...
        /// </para>
        /// </summary>
        public void condenseTree(Node<T> l)
        {
        ...
        /// </summary>
        public Node<T> chooseNode(Rectangle r, int level)
        {
        ...
        /// </summary>
        public Node<T> adjustTree(Node<T> n, Node<T> nn)
        {
        ...
        /// </summary>
        public void checkConsistency(int nodeId, int expectedLevel, Rectangle expectedMBR)
        {
            // go through the tree, and check that the public data structures of 
        ...
        /// </summary>
        public Rectangle calculateMBR(Node<T> n)
        {
